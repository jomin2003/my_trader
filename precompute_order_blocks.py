...
def main():
    ...
    if out_df.empty:
        # No setups in today's window is a normal market condition, not a
        # pipeline failure. Keep any existing table rather than wiping it.
        log.warning("No OBs found today — keeping existing ob_data.csv if present.")
        return
